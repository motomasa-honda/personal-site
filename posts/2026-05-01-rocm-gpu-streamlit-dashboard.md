...
- Mac（192.168.2.1）からUbuntu（192.168.2.2）に `http://192.168.2.2:8502` でアクセス
...
Mac側のブラウザから `http://192.168.2.2:8502` でアクセス。
...
- 構成: Mac mini M4 (192.168.2.1) ↔ Ubuntu 24.04 RX 7900 XTX (192.168.2.2)
